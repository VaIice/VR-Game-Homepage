...
{ secretPage, pageNumber } from './ReportBulletinBoard';
...
export default function ReportBulletinBoardPage(bno) {
        ...
        .then(async (res) => {
            if (res.isConfirmed) {
                try {
                    ...
                    console.log('url : ', `${process.env.REACT_APP_SERVER_URL}/boards/remove/REPORT/${bnum}`)
                    goToReportBulletinBoard();
                } catch (error) {
    ...
    const handlePage = async (page) => {
        ...
        console.log(`${process.env.REACT_APP_SERVER_URL}/replies/REPORT/list/2`);
        const fetchData = async () => {
